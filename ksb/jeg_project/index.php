...
include $_SERVER['DOCUMENT_ROOT']."/lib/thumb.lib.php";
include $_SERVER['DOCUMENT_ROOT']."/lib/header.print.php";
?>
...
<body>
            ...
            <!--div class="container">
                <div class="content">
                    <div class="title-area">
                        <p>Free Demo</p>
                        <h1 class="title-modern">정은교 필라테스</h1>
    ...
    <div class="section section-our-clients-freebie">
        <div class="container">
            <div class="title-area">
                <h5 class="subtitle text-gray">CONTACT</h5>
                <h2>상담 예약</h2>
                <!--div class="separator separator-danger">∎</div-->
            </div>
            <div class="tab-content">
                <div class="tab-pane active" id="testimonial1">
                    ...
                    <form id="myForm" >    
                        <div class="form-group">
        	        	    ...
        	        	    <p class="" id="name_help"></p>
        	        	    <input type="text" name="userEmail" id="userEmail" placeholder="e-mail" class="form-control" />
        	        	    <input type="text" name="userHP" id="userHP" placeholder="H.P" class="form-control" />
        	        	    <textarea name="userComment" id="userComment" class="form-control" style="height:100px;"></textarea>

                	    </div>
                	     <div class="button-get-started">
                            <a href="#gaia" class="btn btn-danger btn-fill btn-lg" onclick='online_ajax(); return false;'>Contact Us</a>
                        </div>
                    </form>
                    </p>
                </div>
...
f.addEventListener("focusin", myFocusFunction);
f.addEventListener("focusout", myBlurFunction);
...
function online_ajax(){
    ...
    if(userName == ""){
        document.getElementById('name_help').innerHTML = "이름을 입력하세요";
        //$("#name_help").innerHTML = '이름을 입력하세요';
        //alert("이름을 입력하세요.");
        $("#userName").focus();
        return false;
    }else{
